...
Webdiyer.MvcPager.prototype = {
    ...
    init: function () {
        ...
        this.invalidPageErrMsg = wrapper.data("invalidPageError");
        this.outOfRangeErrMsg = wrapper.data("outRangeError");
        ...
        var context = this;
        if (this.isAjaxPager) {
            this.updateTarget = wrapper.data("ajaxUpdate");
            this.onBegin = wrapper.data("ajaxBegin");
            this.onComplete = wrapper.data("ajaxComplete");
            this.onFailure = wrapper.data("ajaxFailure");
            this.onSuccess = wrapper.data("ajaxSuccess");
            this.confirm = wrapper.data("ajaxConfirm") || undefined;
            this.httpMethod = wrapper.data("ajaxMethod") || "GET";
            this.loadingElementId = wrapper.data("ajaxLoading") || undefined;
            this.searchForm = wrapper.data("ajaxSearchForm") || undefined;
            this.allowCache = wrapper.data("ajaxCache") || true;
            var history = wrapper.data("ajaxHistory");
            ...
            if (typeof this.searchForm !== "undefined") {
                var isAjaxForm = $(context.searchForm).data("ajax") || false;
                $(context.searchForm).submit(function (event) {
                    context.searchCriteria = $(context.searchForm).serializeArray();
                    if (isAjaxForm) {
    ...
    __ajax: function (index, options) {
        ...
        if (typeof Webdiyer.__ajaxPages[context.pageIndexName] === "undefined" || Webdiyer.__ajaxPages[context.pageIndexName] !== index || context.allowReload) { //prevent duplicate ajax requests
            ...
            if (typeof context.searchForm !== "undefined") {
